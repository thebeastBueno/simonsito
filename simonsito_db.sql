...
INSERT INTO `estudiantes` VALUES (1,'kevin','2025-06-19','el roble','madrid','extrangero',1,NULL,1,1,'mojado','simonsito_admin','2025-06-02 02:13:44'),(2,'maron','2025-06-19','lomas','roma','china',1,NULL,1,1,'comida','simonsito_admin','2025-06-03 05:51:11'),(3,'morales','2025-06-24','el cruce','roma','gapones',2,2,3,2,'a las plantas ','simonsito_admin','2025-06-04 00:23:10');
...
INSERT INTO `inscripciones` VALUES (2,NULL,NULL,1,'simonsito_admin','2025-06-03 06:13:58',2,5,3,2),(3,NULL,NULL,3,'simonsito_admin','2025-06-04 00:27:18',1,5,3,1);
...
INSERT INTO `madres` VALUES (2,'josefa','454545454','nada','V','Si','la calle','No',NULL,'4544445','simonsito_admin','2025-05-29 01:55:40',NULL,NULL),(5,'adriana',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'56568998','simonsito_admin','2025-06-03 05:57:46','rojaz','454878454');
...
CREATE TABLE `users` (
  ...
  `role` enum('administrador','representante') NOT NULL DEFAULT 'representante',
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,'admin','$2y$10$348thlE0gsvknDLB2j2bE.fzKxztF6LDC97lrroJRVBED.QgcY566','administrador'),(2,'roky','$2y$10$HXEuQin4CHGPcAZtebTtUu0PBJZBJYnOXDOFdr7ha0/0qmoHvMuJO','representante');
...
-- Dump completed on 2025-06-05  0:21:08
